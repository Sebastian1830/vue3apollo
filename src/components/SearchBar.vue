<template>
  <form class="hidden md:block max-w-6xl mx-auto mb-16">
    <div class="relative h-full w-full focus:ring-indigo-500 focus:border-indigo-500 shadow-sm text-2xl border-gray-300 bg-gray-200 rounded-xl px-7 py-7 bg-opacity-70">
      <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" class="absolute transform -translate-y-1/2 top-1/2 left-4 h-auto w-10" style="color: #4A5568;">
      ...
      <input class="h-full block bg-transparent relative left-10 border-none outline-none" placeholder="Ex. React" style="width: calc(100% - 3.5rem);" @input="handleInputChange" />
    </div>
  </form>
</template>
